...
<!-- Mirrored from guidebook.webuildthemes.com/html/docs/layout-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Jan 2019 02:14:00 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <nav class="navbar navbar-expand-lg navbar-light">
            <a href="../../index-2.html" class="navbar-brand"><img src="assets/default/images/logo.svg" alt="Logo"></a>
              ...
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown-1">
                    <a class="dropdown-item active" href="layout-1.html">Layout 1</a>
                    <a class="dropdown-item" href="layout-2.html">Layout 2</a>
                    <a class="dropdown-item" href="layout-3.html">Layout 3</a>
                    <a class="dropdown-item" href="layout-4.html">Layout 4</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown-2">
                    <a class="dropdown-item" href="../help/homepage-1.html">Homepage 1</a>
                    <a class="dropdown-item" href="../help/homepage-2.html">Homepage 2</a>
                    <a class="dropdown-item" href="../help/homepage-3.html">Homepage 3</a>
                    <a class="dropdown-item" href="../help/category.html">Category</a>
                    <a class="dropdown-item" href="../help/category-inner.html">Category Inner</a>
                    <a class="dropdown-item" href="../help/article-1.html">Article 1</a>
                    <a class="dropdown-item" href="../help/article-2.html">Article 2</a>
                    <a class="dropdown-item" href="../help/tutorial.html">Tutorial</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown-3">
                    ...
                    <a class="dropdown-item" href="../pages/changelog.html">Changelog</a>
                    ...
                    <a class="dropdown-item" href="../pages/404.html">404</a>
                  </div>
                </li>
              </ul>
              <ul class="navbar-nav">
        ...
        <div class="row justify-content-between">
          ...
          <article id="content" class="col-lg-7">
            ...
            <section id="section-1">
              <h2 class="section-title">Typography <a data-scroll href="#section-1" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
            ...
            <section id="section-2">
              <h2 class="section-title">Colors <a data-scroll href="#section-2" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt rerum minima a possimus, amet perferendis, temporibus obcaecati pariatur. Reprehenderit magnam necessitatibus vel culpa provident quas nesciunt sunt aut cupiditate fugiat!</p>
            ...
            <section id="section-3">
              <h2 class="section-title">File Tree <a data-scroll href="#section-3" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
            ...
            <section id="section-4">
              <h2 class="section-title">Table <a data-scroll href="#section-4" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet adipisci non similique quia maxime molestias id, laboriosam cumque doloribus reprehenderit eaque minus quisquam eius a perferendis ut. Ipsum, dignissimos laboriosam.</p>
              <div class="row">
                <div class="col">
            ...
            <section id="section-5">
              <h2 class="section-title">Accordion <a data-scroll href="#section-5" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet adipisci non similique quia maxime molestias id, laboriosam cumque doloribus reprehenderit eaque minus quisquam eius a perferendis ut. Ipsum, dignissimos laboriosam.</p>
              <div class="row">
                <div class="col">
            ...
            <section id="section-6">
              <h2 class="section-title">Video <a data-scroll href="#section-6" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet adipisci non similique quia maxime molestias id, laboriosam cumque doloribus reprehenderit eaque minus quisquam eius a perferendis ut. Ipsum, dignissimos laboriosam.</p>
              <div class="row">
                <div class="col">
                  <video
            ...
            <section id="section-7">
              <h2 class="section-title">Code <a data-scroll href="#section-7" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
  ...
  > footer {
    ...
    overflow: hidden;
            ...
            <section id="section-8">
              <h2 class="section-title">Alert <a data-scroll href="#section-8" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet adipisci non similique quia maxime molestias id, laboriosam cumque doloribus reprehenderit eaque minus quisquam eius a perferendis ut. Ipsum, dignissimos laboriosam.</p>
              <div class="row">
                <div class="col">
            ...
            <section id="section-9">
              <h2 class="section-title">List <a data-scroll href="#section-9" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet adipisci non similique quia maxime molestias id, laboriosam cumque doloribus reprehenderit eaque minus quisquam eius a perferendis ut. Ipsum, dignissimos laboriosam.</p>
              <div class="row">
                <div class="col-md-6">
            ...
            <section id="section-10">
              <h2 class="section-title">Carousel <a data-scroll href="#section-10" class="anchor" data-toggle="tooltip" data-placement="top" title="Copy URL"></a></h2>
              ...
              <div class="row">
                <div class="col">
                  <div class="owl-carousel" data-items="[1,1,1]" data-margin="20" data-nav="true">
                    <figure class="photo">
                      <a class="lightbox" href="assets/default/images/image-1.jpg" title="Image title">
                        <img src="assets/default/images/image-1.jpg" alt="Image">
                      </a>
                    </figure>
                    <figure class="photo">
                      <a class="lightbox" href="assets/default/images/image-1.jpg" title="Image title">
      ...
      <div class="container">
        <div class="row gutter-3">
          <div class="col-12 col-md-2">
            <a href="#"><img src="assets/default/images/logo-white.svg" alt="Logo"></a>
          </div>
...
<!-- Mirrored from guidebook.webuildthemes.com/html/docs/layout-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Jan 2019 02:14:02 GMT -->
</html>