            ...
            <div class="stats-label text-color">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu animated flipInX m-t-xs">
                        ...
                        <li><a href="profile.html">Хувийн мэдээлэл</a></li>
                        <li class="divider"></li>
    ...
    <div class="normalheader ">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>Математик хичээлтэй хамааралтай ангиллын бүртгэгдсэн мэдээллүүд</small>
            </div>
        </div>
    </div>
...
<div class="content">
    <div class="row">
        <div class="col-lg-12">
            <div class="back-link">
                <a href="../math/new_category" class="btn w-xs btn-success">Ангилал нэмэх</a>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="hpanel">
