          ...
          <div class="header-body">
            <div class="row align-items-end">
              ...
              <div class="col-auto">
                ...
                <!-- Button -->
                <a href="math/new_task" class="btn btn-primary">
                  Бодлого нэмэх 
                </a>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">
                          <a href="#" class="text-muted sort" data-sort="tables-first">Бодлого</a>
                        </th>
                        <th scope="col">
                          <a href="#" class="text-muted sort" data-sort="tables-last">Ангилал</a>
                        </th>
                        <th scope="col">
                          <a href="#" class="text-muted sort" data-sort="tables-handle">Түвшин</a>
                        </th>
                        <th scope="col">
                          <a href="#" class="text-muted sort" data-sort="tables-handle">Вариант</a>
                        </th>
                      </tr>
                    </thead>
                    <tbody class="list">
