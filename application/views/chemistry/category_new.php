    ...
    <div class="small-header">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>Хими хичээлтэй хамааралтай ангилал бүртгэл</small>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-heading">
                    ...
                    Ангилал бүртгэх форм
                </div>
                <div class="panel-body">

                    <form action="../chemistry/save_category" method="post" id="form" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            <label>Ангилал</label>
                                            <input type="text" name="category" placeholder="Ангилал нэр" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
